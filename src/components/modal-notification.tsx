...
import { useNotifications, type FlatSummaryItem } from "../hooks/useNotifications";
...
export default function ModalNotification() {
  const { open, items, loading, unreadCount, user, handleOpen, handleClose, goToDetail } = useNotifications();
