...
export default function OrdersTable({ versionId, number }: OrdersTableProps) {
  ...
  useEffect(() => {
    ...
    apiBaseClient
      .get(
        `/api/invoice/get-status-log-by-version-id/${versionId}`
      )
      .then((res) => {
      ...
      .catch((err) => {
        console.error(err);
        setError((err as Error).message || "Error loading status logs");
      })
                    ...
                    {fileUrl ? (
                      <div className="flex gap-2">
                        <button
                          ...
                          onClick={openModal}
                          style={{fontSize: "13px"}}
                          className="inline-flex items-center px-3 py-1 text-xs font-medium rounded-md border border-blue-500 text-blue-600 hover:bg-blue-50 transition"
                        >
                          View
                        </button>
                        ...
                        <button
                          ...
                          style={{fontSize: "13px"}}
                          className="inline-flex items-center px-3 py-1 text-xs font-medium rounded-md border border-green-500 text-green-600 hover:bg-green-50 transition"
                        >
                          Download
                        </button>
                      </div>
